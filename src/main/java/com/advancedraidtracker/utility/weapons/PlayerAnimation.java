...
public enum PlayerAnimation
{
    ...
    GRAY_CHIN("Gray Chinchompa", "GCC", new Color(0, 130, 0), 3, new int[]{7618}, new int[]{}, new int[]{-1, ItemID.CHINCHOMPA}, new int[]{908}),
    ...
    BARRAGE("Barrage", "F", new Color(50, 50, 170), 5, new int[]{1979}, new int[]{}, new int[]{}, new int[]{}),
    BLITZ("Blitz", "F?", new Color(50, 50, 170), 5, new int[]{1978}, new int[]{}, new int[]{}, new int[]{}),
    ...
    VENG_SELF("Veng Self", "VS", new Color(160, 89, 13), -1, new int[]{8316}, new int[]{}, new int[]{}, new int[]{}),
    HUMIDIFY("Humidify", "HU", new Color(20, 20, 200), -1, new int[]{6294}, new int[]{}, new int[]{}, new int[]{}),
    ...
    ACCURSED_SCEPTRE_AUTO("Accursed Sceptre Auto", "acs", new Color(30, 120, 130), 4, new int[]{1167}, new int[]{}, new int[]{}, new int[]{2337}),
    ACCURSED_SCEPTRE_SPEC("Accursed Sceptre Spec", "ACS", new Color(30, 120, 130), 4, new int[]{9961}, new int[]{}, new int[]{}, new int[]{2339}),
