...
public class AkkhaParser extends RoomParser
{
    ...
    public Map<Integer, String> getLines()
    {
        ...
        lines.put(data.get(DataPoint.AKKHA_P3_SPLIT), "Shadow2 End");
        lines.put(data.get(DataPoint.AKKHA_SHADOW_3_SPLIT), "Shadow3 Start");
        lines.put(data.get(DataPoint.AKKHA_P4_SPLIT), "Shadow3 End");
