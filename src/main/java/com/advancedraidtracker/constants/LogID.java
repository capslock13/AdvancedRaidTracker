...
public enum LogID
{
    ...
    MAIDEN_DESPAWNED(17, true, MAIDEN,
            new ParseInstruction(SPLIT, TIME, MAIDEN_SKIP_SPLIT, MAIDEN_30_SPLIT),
    ...
    BLOAT_DOWN(21, true, BLOAT,
            new ParseInstruction(INCREMENT, BLOAT_DOWNS),
            "Down", "Room Tick"),
    BLOAT_DESPAWN(23, true, BLOAT,
            new ParseInstruction(SET, TIME),
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(ROOM_END_FLAG),
            "Despawned", "Room Tick"),
    BLOAT_HP_1ST_DOWN(24, true, BLOAT,
            new ParseInstruction(SET, BLOAT_HP_FIRST_DOWN),
            "HP at First Down", "Bloat HP"),
    BLOAT_SCYTHE_1ST_WALK(25, true, BLOAT,
            new ParseInstruction(INCREMENT, BLOAT_FIRST_WALK_SCYTHES),
            "First Walk Scythes", "Player", "Room Tick"),
    NYLO_PILLAR_SPAWN(30, true, NYLOCAS,
            new ParseInstruction(ROOM_START_FLAG),
            "Pillar Spawn"),
    NYLO_STALL(31, true, NYLOCAS,
            new ParseInstruction(INCREMENT, NYLO_STALLS_TOTAL),
    ...
    BOSS_SPAWN(40, true, NYLOCAS,
            new ParseInstruction(SPLIT, NYLO_BOSS_SPAWN, NYLO_CLEANUP, NYLO_LAST_WAVE),
    ...
    NYLO_DESPAWNED(45, true, NYLOCAS,
            new ParseInstruction(SPLIT, TIME, NYLO_BOSS_DURATION, NYLO_BOSS_SPAWN),
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(ROOM_END_FLAG),
            "Despawn", "Room Tick"),
    ...
    SOTETSEG_ENDED(57, true, SOTETSEG,
            new ParseInstruction(SPLIT, TIME, SOTE_P3_DURATION, SOTE_P3_SPLIT),
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(ROOM_END_FLAG),
            "Room End", "Room Tick"),
    ...
    XARPUS_HEAL(62, true, XARPUS,
            new ParseInstruction(ADD_TO_VALUE, XARP_HEALING),
            "Heal"),
    XARPUS_SCREECH(63, true, XARPUS,
            new ParseInstruction(SET, XARP_SCREECH),
            "Screech", "Room Tick"),
    XARPUS_DESPAWNED(65, true, XARPUS,
            new ParseInstruction(SPLIT, TIME, XARP_POST_SCREECH, XARP_SCREECH),
            new ParseInstruction(ROOM_END_FLAG),
            "Despawned", "Room Tick"),
    ...
    VERZIK_P3_DESPAWNED(76, true, VERZIK,
            new ParseInstruction(SPLIT, TIME, VERZIK_P3_DURATION, VERZIK_P3_SPLIT),
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(ROOM_END_FLAG),
    ...
    VERZIK_CRAB_SPAWNED(78, true, VERZIK,
            ...
            new ParseInstruction(INCREMENT, VERZIK_CRABS_SPAWNED),
    ...
    TOA_ZEBAK_FINISHED(1021, true, ZEBAK,
            new ParseInstruction(SPLIT, TIME, ZEBAK_ENRAGED_DURATION, ZEBAK_ENRAGED_SPLIT),
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(ROOM_END_FLAG),
    ...
    TOA_ZEBAK_BOULDER_ATTACK(1024, true, ZEBAK,
            new ParseInstruction(INCREMENT, ZEBAK_BOULDER_ATTACKS),
            "Zebak Boulder Attack", "Room Tick"),
    TOA_ZEBAK_WATERFALL_ATTACK(1025, true, ZEBAK,
            new ParseInstruction(INCREMENT, ZEBAK_WATERFALL_ATTACKS),
    ...
    TOA_KEPHRI_FINISHED(1045, true, KEPHRI,
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(SPLIT, TIME, KEPHRI_P3_DURATION, KEPHRI_P3_SPLIT),
            new ParseInstruction(ROOM_END_FLAG),
    ...
    TOA_KEPHRI_DUNG_THROWN(1049, true, KEPHRI,
            new ParseInstruction(INCREMENT, KEPHRI_DUNG_THROWN),
    ...
    TOA_BABA_FINISHED(1065, true, BABA,
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(SPLIT, TIME, BABA_P3_DURATION, BABA_P3_SPLIT),
            new ParseInstruction(ROOM_END_FLAG),
    ...
    TOA_HET_DOWN(1073, true, HET,
            new ParseInstruction(INCREMENT,HET_DOWNS),
            "Het Down", "Room Tick"),
    ...
    TOA_AKKHA_FINISHED(1090, true, AKKHA,
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(SPLIT, TIME, AKKHA_FINAL_PHASE_DURATION, AKKHA_FINAL_PHASE_SPLIT),
            new ParseInstruction(ROOM_END_FLAG),
    ...
    TOA_WARDENS_FINISHED(1204, true, WARDENS,
            new ParseInstruction(ADD_TO_VALUE, CHALLENGE_TIME),
            new ParseInstruction(SPLIT, TIME, WARDENS_ENRAGED_DURATION, WARDENS_ENRAGED_SPLIT),
