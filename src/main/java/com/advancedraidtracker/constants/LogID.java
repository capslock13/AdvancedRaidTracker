...
public enum LogID
{
    ...
    INFERNO_TIMER_STARTED(3000, true, INFERNO,
            new ParseInstruction(MANUAL_PARSE),
    ...
    INFERNO_NPC_SPAWN(3004, true, INFERNO,
            new ParseInstruction(MANUAL_PARSE),
            "Inferno NPC Spawn", "Npc ID", "RegionX", "RegionY", "Respawn?"),
    GRAPHIC_CHANGED_PLAYER(992, true, RaidRoom.ALL,
            new ParseInstruction(MANUAL_PARSE),
            "Graphic Changed", "Player", "graphics", "Room Tick", "Room Name"),
