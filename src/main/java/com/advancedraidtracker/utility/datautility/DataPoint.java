...
public enum DataPoint
{
    ...
    COLOSSEUM_WAVE_1_DURATION("Wave 1 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_2_SPLIT("Wave 2 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_2_DURATION("Wave 2 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_3_SPLIT("Wave 3 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_3_DURATION("Wave 3 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_4_SPLIT("Wave 4 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_4_DURATION("Wave 4 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_5_SPLIT("Wave 5 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_5_DURATION("Wave 5 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_6_SPLIT("Wave 6 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_6_DURATION("Wave 6 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_7_SPLIT("Wave 7 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_7_DURATION("Wave 7 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_8_SPLIT("Wave 8 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_8_DURATION("Wave 8 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_9_SPLIT("Wave 9 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_9_DURATION("Wave 9 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_10_SPLIT("Wave 10 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_10_DURATION("Wave 10 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_11_SPLIT("Wave 11 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_11_DURATION("Wave 11 Duration", types.TIME_SPLIT, COLOSSEUM, TIME),
    COLOSSEUM_WAVE_12_SPLIT("Wave 12 Split", types.TIME_SPLIT, COLOSSEUM, TIME),
